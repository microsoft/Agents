...
|----|----|----|----|
|QuickStart/Empty Agent|Tier 1: QuickStart|Simplest agent|N/A|
...
|Cards|Tier 2: Scenario starter|Sending and receiving adaptive cards|[cards](cards/README.md)|
|Cards Streaming|Tier 2: Scenario starter|Streaming adaptive cards|[cards-streaming](cards-streaming/README.md)|
