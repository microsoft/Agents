# Microsoft 365 Agents JavaScript SDK Samples list
...
|Integrate LangChain|Tier 2: Scenario starter|WeatherAgent with LangChain|[langchain-multiturn](langchain-multiturn/README.md)|
...
|Copilot Studio Client - React Webchat|Tier 2: Scenario starter|App to consume a Copilot Studio Agent integrated with a Webchat Client|[copilotstudio-webchat-react](copilotstudio-webchat-react/README.md)|
|Copilot Studio Webclient|Tier 2: Scenario starter|Webclient for Copilot Studio integration|[copilotstudio-webclient](copilotstudio-webclient/README.md)|
